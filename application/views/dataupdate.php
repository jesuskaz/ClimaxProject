        ...
        <div class="row">
          <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-8 offset-lg-2 col-xl-8 offset-xl-2">
            <div class="card card-primary">
              ...
              <div class="card-body">
                <form method="post" action="<?php echo site_url('poster/update'); ?>" class="needs-validation" novalidate="" enctype="multipart/form-data">
                  <div class="row">
                  ...
                  <div class="form-group">
                    ...
                    <input type="submit" name="modifier" class="btn btn-primary btn-lg btn-block" value = "Modifier" id="swal-2"/>
                  </div>
                  <div class="form-group">
