      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              <a href="auth-login.html" class="nav-link"><i data-feather="log-in"></i><span>Log in</span></a>
            </li>
            <li class="dropdown">
              <a href="index.html" class="nav-link"><i data-feather="log-out"></i><span>Déconnecter</span></a>
            </li>
          </ul>
        </aside>
      </div>
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          <h5 class="font-15">Billets</h5>
                          <h2 class="mb-3 font-18">1,287</h2>
                          <p class="mb-0"><span class="col-green">Réserver pour la finance</span></p>
                        </div>
                      </div>
