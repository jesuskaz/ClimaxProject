      ...
      <div class="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index"> <img alt="image" src="<?php echo base_url().'/assets/img/logo.png';?>" class="header-logo" /> 
              <!-- <span class="logo-name">Climax Movie</span> -->
            </a>
          </div>
        </aside>
      </div>
          ...
          <div class="section-body">
            <div class="row">
              <div class="col-12 col-sm-6 col-lg-6">
                <div class="card">
                  <a href="<?php echo site_url('poster/loginAdmin'); ?>">
